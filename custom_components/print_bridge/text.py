...
from .const import (
    ...
    TEXT_SIGNAL_ACCOUNT,
    TEXT_SIGNAL_ALLOWED_GROUP_IDS,
    TEXT_SIGNAL_ALLOWED_SENDERS,
    TEXT_SIGNAL_MODULE_ID,
    TEXT_SIGNAL_REST_URL,
...
_TEXTS: tuple[_OptionText, ...] = (
    ...
    _OptionText(
        ...
        "mdi:identifier",
        lambda value: value.strip(),
        lambda value: str(value or DEFAULT_SIGNAL_MODULE_ID),
    ),
    _OptionText(
        CONF_SIGNAL_REST_URL,
        TEXT_SIGNAL_REST_URL,
        DEFAULT_SIGNAL_REST_URL,
        "mdi:api",
        lambda value: value.strip().rstrip("/"),
        lambda value: str(value or ""),
    ),
    _OptionText(
        CONF_SIGNAL_ACCOUNT,
